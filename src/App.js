        ...
        <div className="head">
          ...
          <div className='subHead'>
            ...
            <ul>
              ...
              <li>BJP won all the seats in <span className='bold'>8 (out of 37)</span> states and union territories (Arunachal Pradesh(2), Gujarat(26), Haryana(10), Himachal Pradesh(4), NCT of Delhi(7), Rajasthan(25), Tripura(2), Uttarakhand(5)).</li>
              <li>INC was not able to win a any seats in <span className='bold'>17  (out of 37)</span> states and union territories.</li>
