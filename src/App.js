    ...
    <div className="App">
      <div className='main-body'>
        <div className="head">
          ...
          <div className="subHead">In 2019; <span className='bold'>8 049</span> candidates contested the elections <span role='img' aria-label="balot-box emoji" className='button-icon'>🗳️</span> for <span className='bold'>543</span> seats (on average 15 contestants per seat) in Lok Sabha <span role='img' aria-label="government-building-emoji">🏛️</span>. These candidates represented <span className='bold'>677</span> political parties.</div>
